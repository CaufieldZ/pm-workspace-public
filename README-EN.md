...
| code-review | Incremental code review over `git diff` (Phase 1 script aggregates mechanical gates + consumer back-reference, Phase 2 model does semantic review), review-only |
