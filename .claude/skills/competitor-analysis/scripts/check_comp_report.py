...
用法：
    python3 check_comp_report.py <report.md>     # 检查一份报告
    python3 check_comp_report.py --help          # 本帮助

参数：<report.md> = 竞品分析报告 md 路径（comp-*.md）。
...
退出码：0 = 全过或仅 WARN；1 = 有 FAIL；2 = 用法错 / 读不到文件。
"""
import re
import sys
