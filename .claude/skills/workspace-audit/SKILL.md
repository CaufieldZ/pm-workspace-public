...
示例：
- 全部执行：`bash .claude/skills/workspace-audit/references/audit.sh 1,2,3,4,5,6,7,12`
- 只跑 pre-commit 覆盖的：`bash .claude/skills/workspace-audit/references/audit.sh 1,2,3,4,7,12`
