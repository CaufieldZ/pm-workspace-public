...
用法：
    python3 scripts/check_decisions.py                        # 默认扫 .claude/decisions/ 全部
    python3 scripts/check_decisions.py path/to/note.md ...    # 只查指定文件 / 目录
    python3 scripts/check_decisions.py --strict               # 有违规 exit 2（hook / CI 用）
