...
def main():
    parser = argparse.ArgumentParser(
        description="BI 平台报告下载 CLI（凭证读 .env 的 YOUSHU_BASE / YOUSHU_TOKEN_KEY）",
...
示例:
  ...
  python3 scripts/youshu_cli.py flush-cache --data-connection-id 100000000 --table demo_table --database demo_database
